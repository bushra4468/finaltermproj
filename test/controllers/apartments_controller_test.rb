...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post apartments_url, params: { apartment: { email: @apartment.email, name: @apartment.name, phone: @apartment.phone } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { email: @apartment.email, name: @apartment.name, phone: @apartment.phone } }
